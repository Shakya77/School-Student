...
export default function Login() {
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-10 py-16">
                <div className="max-w-xl mx-auto">
                    ...
                    <div className="flex gap-4 font-medium text-white">
                        <button className="flex items-center px-6 py-3 rounded-md border bg-blue-500">
                            <Icon icon="tabler:presentation" className="mr-2" width="20" height="20" />
                            Request Demo
                        </button>
                        <button onClick={handleClick} className="text-black flex items-center px-6 py-3 rounded-md border border-blue-500">
